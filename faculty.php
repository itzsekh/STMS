			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Teacher</b>
						<span class="float:right"><a class="btn btn-dark btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_faculty">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-dark edit_faculty" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
