			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						...
						<span class="float:right"><a class="btn btn-dark btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_class_subject">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-dark edit_class_subject" type="button" data-id="<?php echo $row['id'] ?>" >Edit</button>
