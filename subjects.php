							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-dark edit_subject" type="button" data-id="<?php echo $row['id'] ?>"  data-subject="<?php echo $row['subject'] ?>"  data-description="<?php echo $row['description'] ?>" >Edit</button>
